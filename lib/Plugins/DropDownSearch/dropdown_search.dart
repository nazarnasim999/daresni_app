...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
            ...
            if (widget.title != null)
              Text(
                ...
                style: AppTStyle.regularStyle12.copyWith(
                  color: widget.forTutor ? AppTheme.secondaryColor : AppTheme.primaryColor,
                ),
              ),
          ...
          children: [
            if (widget.title != null)
              Text(
                widget.title!,
                style: AppTStyle.regularStyle12.copyWith(
                  color: widget.forTutor ? AppTheme.primaryColor : AppTheme.secondaryColor,
                ),
              ),
            if (widget.isRequiredField) Text("*", style: TextStyle(color: AppTheme.primaryColor)),
          ],
              ...
              return ValueListenableBuilder<bool>(
                  ...
                  builder: (context, isFocused, w) {
                    return InputDecorator(
                      ...
                      textAlignVertical: widget.dropdownDecoratorProps.textAlignVertical,
                      isEmpty:
                          getSelectedItems.isEmpty && widget.dropdownBuilderMultiSelection == null,
                      isFocused: isFocused,
                      decoration: _manageDropdownDecoration(state),
                      child: _defaultSelectedItemWidget(),
                    );
  ...
  ///[areas] selected item to be passed to the UI
