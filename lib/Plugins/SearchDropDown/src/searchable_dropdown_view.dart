...
class SearchableDropdown<T> extends StatefulWidget {
  ...
  Future<List<SearchableDropdownMenuItem<T>>?> Function(int page, String? searchKey)?
      paginatedRequest;
...
class _SearchableDropdownState<T> extends State<SearchableDropdown<T>> {
  ...
  _dropDownOnTab(BuildContext context, SearcableDropdownController<T> controller) {
    ...
    double? dialogPossitionFromBottom =
        possitionFromBottom != null ? possitionFromBottom - alertDialogMaxHeight : null;
  ...
  Widget _buildStatefullDropdownCard(
      BuildContext context, SearcableDropdownController<T> controller, bool isReversed) {
    return Column(
        ...
        Flexible(
          child: Card(
            ...
            shape: RoundedRectangleBorder(
                borderRadius:
                    BorderRadius.all(Radius.circular(MediaQuery.of(context).size.height * 0.015))),
            child: Column(
